angular.module('VolpayApp').controller('createpasswordCtrl', function ($scope, $http, $stateParams, $state, $rootScope, $filter, $timeout, $location, GlobalService, errorservice, $translate, userProfileSave) {
