angular.module('VolpayApp').controller('statementListController', function($scope, $timeout, StmtPersonService, $location, $state, $http, $translate, GlobalService, bankData, $filter, LogoutService, $rootScope, CommonService, EntityLockService) {
    ...
    $scope.setInitval = function() {
        ...
        $http({
            ...
            for (var i in data) {
                $scope.psaCodeDrop = data[i].PartyServiceAssociationCode
            }
    ...
    $scope.readAll = function(query) {
        ...
        StmtPersonService.filelistSearch(query).then(function(items) {          
    ...
    function initialCall(adSearch) {
        ...
        if (!adSearch) {
            ...
            /*StmtPersonService.filelistSearch($scope.Qobj).then(function(items){
            if (items.response == 'Error') {
            ...
            $scope.nothingSelected = true;
            StmtPersonService.filterData($scope.txtValfn(), "All", $scope.orderByField, $scope.sortType).then(function (items) {
            ...
            StmtPersonService.filterData($scope.txtValfn(), "Today", $scope.orderByField, $scope.sortType).then(function (items) {
            $scope.totalData = items.tCnt;
            if (items.response == 'Error') {
            $scope.showErrorMessage(items)
            } else {
            ...
            StmtPersonService.filterData($scope.txtValfn(), "Week", $scope.orderByField, $scope.sortType).then(function (items) {
            $scope.totalData = items.tCnt;
            if (items.response == 'Error') {
            $scope.showErrorMessage(items)
            } else {
            ...
            StmtPersonService.filterData($scope.txtValfn(), "Month", $scope.orderByField, $scope.sortType).then(function (items) {
            $scope.totalData = items.tCnt;
            if (items.response == 'Error') {
            $scope.showErrorMessage(items)
            } else {
            ...
            $scope.ShowStartDate = GlobalService.startDate;
            $scope.ShowEndDate = GlobalService.endDate;
            StmtPersonService.customSearch($scope.startDate, $scope.endDate, $scope.txtValfn(), $scope.orderByField, $scope.sortType).then(function (items) {
            $scope.totalData = items.tCnt;
            if (items.response == 'Error') {
            $scope.showErrorMessage(items)
            } else {
            ...
            if ($scope.all) {
                $scope.nothingSelected = true;
                StmtPersonService.retainStmtSearchResults(FieldArr, $scope.aa, "All", $scope.orderByField, $scope.sortType).then(function(items) {
                ...
                $scope.nothingSelected = false;
                $scope.todayDate = GlobalService.todayDate;
                StmtPersonService.retainStmtSearchResults(FieldArr, $scope.aa, "Today", $scope.orderByField, $scope.sortType).then(function(items) {
                ...
                StmtPersonService.retainStmtSearchResults(FieldArr, $scope.aa, "Week", $scope.orderByField, $scope.sortType).then(function(items) {
                ...
                StmtPersonService.retainStmtSearchResults(FieldArr, $scope.aa, "Month", $scope.orderByField, $scope.sortType).then(function(items) {
                ...
                StmtPersonService.retainCustomSearchResults(FieldArr, $scope.startDate, $scope.endDate, $scope.orderByField, $scope.sortType).then(function(items) {
    ...
    $scope.Sorting = function(orderByField) {
        ...
        if (!$scope.advancedSearchEnable) {
            ...
            /*if ($scope.all) {
            StmtPersonService.getFeedNewAllSorting($scope.txtValfn(), $scope.orderByField, $scope.sortType, $scope.aa, 'all').then(function (items) {
            ...
            $scope.todayDate = GlobalService.todayDate;
            StmtPersonService.getFeedNewAllSorting($scope.txtValfn(), $scope.orderByField, $scope.sortType, $scope.aa, 'Today').then(function (items) {
            ...
            $scope.weekStart = GlobalService.weekStart;
            $scope.weekEnd = GlobalService.weekEnd;
            StmtPersonService.getFeedNewAllSorting($scope.txtValfn(), $scope.orderByField, $scope.sortType, $scope.aa, 'Week').then(function (items) {
            ...
            $scope.monthStart = GlobalService.monthStart;
            $scope.monthEnd = GlobalService.monthEnd;
            StmtPersonService.getFeedNewAllSorting($scope.txtValfn(), $scope.orderByField, $scope.sortType, $scope.aa, 'Month').then(function (items) {
            ...
            StmtPersonService.getFeedNewAllCustomSorting($scope.startDate, $scope.endDate, $scope.txtValfn(), $scope.orderByField, $scope.sortType, $scope.aa).then(function (items) {
            ...
            if ($scope.all) {
                $scope.nothingSelected = true;
                StmtPersonService.advancedSearchSorting($scope.orderByField, $scope.sortType, $scope.aa, "All", FieldArr).then(function(items) {
                    if (items.response == 'Error') {
                        $scope.showErrorMessage(items)
                    } else {
                        $scope.defaultCallValues(items.data)
                ...
                $scope.todayDate = GlobalService.todayDate;
                $scope.nothingSelected = false;
                StmtPersonService.advancedSearchSorting($scope.orderByField, $scope.sortType, $scope.aa, "Today", FieldArr).then(function(items) {
                    if (items.response == 'Error') {
                        $scope.showErrorMessage(items)
                    } else {
                        $scope.defaultCallValues(items.data)
                ...
                $scope.weekEnd = GlobalService.weekEnd;
                $scope.nothingSelected = false;
                StmtPersonService.advancedSearchSorting($scope.orderByField, $scope.sortType, $scope.aa, "Week", FieldArr).then(function(items) {
                    if (items.response == 'Error') {
                        $scope.showErrorMessage(items)
                    } else {
                        $scope.defaultCallValues(items.data)
                ...
                $scope.monthEnd = GlobalService.monthEnd;
                $scope.nothingSelected = false;
                StmtPersonService.advancedSearchSorting($scope.orderByField, $scope.sortType, $scope.aa, "Month", FieldArr).then(function(items) {
                    if (items.response == 'Error') {
                        $scope.showErrorMessage(items)
                    } else {
                        $scope.defaultCallValues(items.data)
                ...
                $scope.startDate = GlobalService.startDate;
                $scope.endDate = GlobalService.endDate;
                StmtPersonService.advancedSearchCustomSorting($scope.startDate, $scope.endDate, $scope.orderByField, $scope.sortType, $scope.aa, FieldArr).then(function(items) {
                    if (items.response == 'Error') {
                        $scope.showErrorMessage(items)
                    } else {
                        $scope.defaultCallValues(items.data)
    ...
    $scope.loadMore = function() {
        ...
        if (!$scope.advancedSearchEnable) {
            ...
            if (!$scope.isSortingClicked) {
                if ($scope.all) {
                    StmtPersonService.filterDataLoadmore($scope.txtValfn(), $scope.aa, "All", $scope.orderByField, $scope.sortType).then(function(items) {
                    ...
                    StmtPersonService.filterDataLoadmore($scope.txtValfn(), $scope.aa, "Today", $scope.orderByField, $scope.sortType).then(function(items) {
                        if (items.response == 'Success') {
                            $scope.loadedData = items.data;
                            $scope.items = $scope.items.concat(items.data);
                            $scope.loadedCnt = $scope.items.length;
                    ...
                    StmtPersonService.filterDataLoadmore($scope.txtValfn(), $scope.aa, "Week", $scope.orderByField, $scope.sortType).then(function(items) {
                    ...
                    StmtPersonService.filterDataLoadmore($scope.txtValfn(), $scope.aa, "Month", $scope.orderByField, $scope.sortType).then(function(items) {
                        if (items.response == 'Success') {
                            $scope.loadedData = items.data;
                            $scope.items = $scope.items.concat(items.data);
                            $scope.loadedCnt = $scope.items.length;
                    ...
                    StmtPersonService.customSearchloadmore($scope.startDate, $scope.endDate, $scope.txtValfn(), $scope.aa, $scope.orderByField, $scope.sortType).then(function(items) {
                        if (items.response == 'Success') {
                            $scope.loadedData = items.data;
                            $scope.items = $scope.items.concat(items.data);
                            $scope.loadedCnt = $scope.items.length;
                ...
                if ($scope.all) {
                    StmtPersonService.sortingLoadmore($scope.txtValfn(), $scope.orderByField, $scope.sortType, $scope.aa, "All").then(function(items) {
                    ...
                    StmtPersonService.sortingLoadmore($scope.txtValfn(), $scope.orderByField, $scope.sortType, $scope.aa, "Today").then(function(items) {
                        if (items.response == 'Success') {
                            $scope.loadedData = items.data;
                    ...
                    StmtPersonService.sortingLoadmore($scope.txtValfn(), $scope.orderByField, $scope.sortType, $scope.aa, "Week").then(function(items) {
                    ...
                    StmtPersonService.sortingLoadmore($scope.txtValfn(), $scope.orderByField, $scope.sortType, $scope.aa, "Month").then(function(items) {
                        if (items.response == 'Success') {
                            $scope.loadedData = items.data;
                    ...
                    StmtPersonService.sortingCustomSearchLoadmore($scope.startDate, $scope.endDate, $scope.txtValfn(), $scope.orderByField, $scope.sortType, $scope.aa).then(function(items) {
                        if (items.response == 'Success') {
                            $scope.loadedData = items.data;
            ...
            if (!$scope.isSortingClicked) {
                ...
                if ($scope.all) {
                    ...
                    StmtPersonService.advancedSearchLoadmore($scope.aa, "All", $scope.orderByField, $scope.sortType, FieldArr).then(function(items) {
                    ...
                    StmtPersonService.advancedSearchLoadmore($scope.aa, "Today", $scope.orderByField, $scope.sortType, FieldArr).then(function(items) {
                        if (items.response == 'Success') {
                            $scope.loadedData = items.data;
                            $scope.items = $scope.items.concat(items.data);
                            $scope.loadedCnt = $scope.items.length;
                    ...
                    StmtPersonService.advancedSearchLoadmore($scope.aa, "Week", $scope.orderByField, $scope.sortType, FieldArr).then(function(items) {
                    ...
                    StmtPersonService.advancedSearchLoadmore($scope.aa, "Month", $scope.orderByField, $scope.sortType, FieldArr).then(function(items) {
                    ...
                    StmtPersonService.advancedCustomSearchLoadmore($scope.aa, $scope.startDate, $scope.endDate, $scope.orderByField, $scope.sortType, FieldArr).then(function(items) {
                        if (items.response == 'Success') {
                            $scope.loadedData = items.data;
                            $scope.items = $scope.items.concat(items.data);
                            $scope.loadedCnt = $scope.items.length;
                ...
                if ($scope.all) {
                    StmtPersonService.advancedSortingLoadmore($scope.orderByField, $scope.sortType, $scope.aa, "All", FieldArr).then(function(items) {
                    ...
                    StmtPersonService.advancedSortingLoadmore($scope.orderByField, $scope.sortType, $scope.aa, "Today", FieldArr).then(function(items) {
                    ...
                    StmtPersonService.advancedSortingLoadmore($scope.orderByField, $scope.sortType, $scope.aa, "Week", FieldArr).then(function(items) {
                    ...
                    StmtPersonService.advancedSortingLoadmore($scope.orderByField, $scope.sortType, $scope.aa, "Month", FieldArr).then(function(items) {
                        if (items.response == 'Success') {
                    ...
                    StmtPersonService.advancedCustomSortingLoadmore($scope.startDate, $scope.endDate, $scope.orderByField, $scope.sortType, $scope.aa, FieldArr).then(function(items) {
                        if (items.response == 'Success') {
    ...
    $scope.loadData1 = function() {
        ...
        if (sessionStorage.FileListCurrentRESTCALL) {
            StmtPersonService.refreshAll().then(function(items) {
                if (items.response == 'Success') {                   
    ...
    $scope.FileListSearch = function() {
        ...
        $scope.globalEsearch = StmtPersonService.txtBoxVal = $scope.esearch;
        if (c != '') {
    ...
    $scope.clearSearch = function() {
        ...
        GlobalService.FLuir = "",
            ...
            $scope.selectCriteriaTxt = GlobalService.selectCriteriaTxt = "All",
            $scope.selectCriteriaID = GlobalService.selectCriteriaID = 1,
    ...
    $scope.FilterByDate = function(text, eve) {
        ...
        if (!$scope.advancedSearchEnable) {
            ...
            if (text == 'all') {
                ...
                StmtPersonService.advancedSearch(FieldArr, "All", $scope.orderByField, $scope.sortType).then(function(items) {
                ...
                StmtPersonService.advancedSearch(FieldArr, "Today", $scope.orderByField, $scope.sortType).then(function(items) {
                ...
                StmtPersonService.advancedSearch(FieldArr, "Week", $scope.orderByField, $scope.sortType).then(function(items) {
                ...
                StmtPersonService.advancedSearch(FieldArr, "Month", $scope.orderByField, $scope.sortType).then(function(items) {
    ...
    $scope.FilterByDate1 = function() {
        ...
        if (!$scope.advancedSearchEnable) {
            ...
            StmtPersonService.advancedCustomSearch(FieldArr, $scope.startDate, $scope.endDate, $scope.orderByField, $scope.sortType).then(function(items) {
    ...
    function instructionTypes() {
        ...
        $scope.InstructionTypes = [{
                "displayvalue": "Bank Statement",
                "actualvalue": "Bank Statement",
            },
            {
                "displayvalue": "Customer Statement",
                "actualvalue": "Customer Statement",
            }
        ];
    ...
    StmtPersonService.totalFileStatus().then(function(items) {
    ...
    $scope.buildSearch = function() {
        ...
        if ($scope.anythingSelected) {
            ...
            if ($scope.all) {
                ...
                StmtPersonService.advancedSearch($scope.additionalWhereClauseArr, "All", $scope.orderByField, $scope.sortType).then(function(items) {
                ...
                StmtPersonService.advancedSearch($scope.additionalWhereClauseArr, "Today", $scope.orderByField, $scope.sortType).then(function(items) {
                ...
                StmtPersonService.advancedSearch($scope.additionalWhereClauseArr, "Week", $scope.orderByField, $scope.sortType).then(function(items) {
                ...
                StmtPersonService.advancedSearch($scope.additionalWhereClauseArr, "Month", $scope.orderByField, $scope.sortType).then(function(items) {
                ...
                StmtPersonService.advancedCustomSearch($scope.additionalWhereClauseArr, $scope.startDate, $scope.endDate, $scope.orderByField, $scope.sortType).then(function(items) {
    ...
    $scope.makeCall = function() {
        ...
        $http.post(BASEURL + RESTCALL.AllStatementList, $scope.details).then(function onSuccess(response) {
            // Handle success
            var data = response.data;
            var status = response.status;
            var statusText = response.statusText;
            ...
            var colName = ["InstructionID", "InstructionType", "EntryDate", "InputReferenceCode", "Total Number of Payments", "PaymentsCompleted", "PaymentsRejected", "PaymentsPending", "FileStatus", "OrigInstrID"];
    ...
    $scope.getDetailsFromInstructionFieldList = function(xml, fieldname) {
        var jsonData = $filter('Xml2Json')(xml);
        if (jsonData['StatementDetails']) {
            return jsonData['StatementDetails'][fieldname] || ''
        } else {
            return '';
        }
    }
