angular.module('VolpayApp').controller('receivedAccountsListCtrl', function($scope, $rootScope, $http, $state, $location, $compile, GlobalService, bankData, $timeout, $filter, errorservice, EntityLockService) {
    ...
    $scope.navToPaymentFrmOutput = function() {
        ...
        GlobalService.fromPage = 'receivedaccountslist'
