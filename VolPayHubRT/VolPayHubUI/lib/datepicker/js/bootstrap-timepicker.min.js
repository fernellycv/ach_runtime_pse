...
! function(t, i, e) {
    ...
    s.prototype = {
        ...
        getTime: function() {
            return "" === this.hour ? "" : (1 === this.hour.toString().length ? "0" + this.hour : this.hour) + ":" + (1 === this.minute.toString().length ? "0" + this.minute : this.minute) + (this.showSeconds ? ":" + (1 === this.second.toString().length ? "0" + this.second : this.second) : "") + (this.showMeridian ? " " + this.meridian : "")
        },
        hideWidget: function() {
            ...
            if (this.showMeridian) {
				...
				if(23 === this.hour){
					this.hour = '00';
						...
						if(parseInt(this.hour,10) < 9){							
							this.hour = parseInt(this.hour,10) + 1;					
							this.hour = '0' + this.hour 
						}
						else{
							this.hour = parseInt(this.hour,10) + 1;	
        ...
        setDefaultTime: function(t) {
            if (this.$element.val()) this.updateFromElementVal();
                ...
                var i = new Date,
                    ...
                    n = i.getSeconds(),
                    h = "AM";
                0 !== n && (n = Math.ceil(i.getSeconds() / this.secondStep) * this.secondStep, 60 === n && (s += 1, n = 0)), 0 !== s && (s = Math.ceil(i.getMinutes() / this.minuteStep) * this.minuteStep, 60 === s && (e += 1, s = 0)), this.showMeridian && (0 === e ? e = 12 : e >= 12 ? (e > 12 && (e -= 12), h = "PM") : h = "AM"), this.hour = (e < 10) ? '0'+e : e, this.minute = s, this.second = n, this.meridian = h, this.update()
        ...
        updateWidget: function() {
            if (this.$widget !== !1) {
                var t = 1 === this.hour.toString().length ? "0" + this.hour : this.hour,
